 ...
 * data files like assets/vehicles.json, without pulling in a third-party
 ...
 *
 * PLATFORM_PC only: consumers are the desktop game (vehicle.c) and the
 * host-side bake tool (tools/obj2c.c); the GameCube build reads no JSON
 * at runtime (see vehicle.h).
 */
#ifndef JSON_H
#define JSON_H
