 ...
 * used for both the character and vehicle select screens.
 *
...
/* One 0..10 stat bar. `present` = 0 renders as "--" (e.g. the reserved
   "weight" stat that's currently null in vehicles.json). */
typedef struct {
