 ...
 * steps regardless of display rate, which keeps the movement feel stable.
 */
#ifdef PLATFORM_PC
...
/*
 * Assets (character models, textures, etc.) are loaded via plain relative
 * paths, which only resolve correctly if the process's current working
 * directory happens to
...
int main(int argc, char **argv) {
    ...
    win = SDL_CreateWindow("3D Platformer",
