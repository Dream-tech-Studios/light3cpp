/*
 * character.c - see character.h. A JSON list load + a thin wrapper over
 * model_load.c, so adding a playable character is just a new JSON entry
 * plus its model/texture, no code changes.
 */
